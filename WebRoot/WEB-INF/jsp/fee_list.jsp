    ...
    <body>
        ...
        <div id="main">
            <form action="" method="">
                ...
                <!--分页-->
                <div>撒地方阿斯蒂芬撒地方第三方</div>
                <div id="pages">
        	        <a href="">上一页</a>
                	<s:iterator begin="1" end="totalpage">
                		<s:if test="pages==top">
                		<a href="costList.action?pages=${top }" class="current_page">${top }</a>
                		</s:if>
                		<s:else>
	                		<a href="costList.action?pages=${top }" >${top }</a>
                		</s:else>
                	</s:iterator>
                    <a href="">下一页</a>
                </div>
